    ...
    <template slot="main">
      <page-header>
        ...
        <template slot="action">
          <a
            href="#"
            v-permission="['update_datatopics']"
        ...
        <template slot="menu">
          <div class="dropdown" v-if="id !== 'create'">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
              <a
                href="#"
                v-permission="['delete_datatopics']"
  ...
  methods: {
    fetchData() {
      this.request()
        ...
        .catch(error => {
          this.$router.push({ name: "datatopics" });
        });
    },
    ...
    saveTopic() {
      ...
      this.request()
        .post("/api/v1/datatopics/" + this.id, this.form)
        .then(response => {
    ...
    deleteTopic() {
      this.request()
        .delete("/api/v1/datatopics/" + this.id)
        .then(response => {
