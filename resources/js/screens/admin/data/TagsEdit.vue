  ...
  methods: {
    fetchData() {
      this.request()
        ...
        .catch(error => {
          this.$router.push({ name: "datatags" });
        });
    },
    ...
    saveTag() {
      ...
      this.request()
        .post("/api/v1/datatags/" + this.id, this.form)
        .then(response => {
    ...
    deleteTag() {
      this.request()
        .delete("/api/v1/datatags/" + this.id)
        .then(response => {
