  ...
  <admin-page>
    <template slot="main">
          ...
          <div class="form-group mb-5">
            <div class="col-lg-12">
              <input
                ...
                v-model="form.name"
                title="Name"
                @keyup.enter="saveMinistry"
                class="form-control-lg form-control border-0 px-0 bg-transparent"
                :placeholder="trans.app.give_your_ministry_a_name"
              />
            ...
            <div class="col-lg-12">
              <input
                ...
                @keyup.enter="saveMinistry"
                class="form-control-lg form-control border-0 px-0 bg-transparent"
                :placeholder="trans.app.give_your_ministry_a_hq"
              />
            ...
            <div class="col-lg-12">
              <input
                ...
                @keyup.enter="saveMinistry"
                class="form-control-lg form-control border-0 px-0 bg-transparent"
                :placeholder="trans.app.give_your_ministry_a_head"
              />
            ...
            <div class="col-lg-12">
              <input
                ...
                @keyup.enter="saveMinistry"
                class="form-control-lg form-control border-0 px-0 bg-transparent"
                :placeholder="trans.app.give_your_ministry_a_email"
              />
            ...
            <div class="col-lg-12">
              <input
                ...
                @keyup.enter="saveMinistry"
                class="form-control-lg form-control border-0 px-0 bg-transparent"
                :placeholder="trans.app.give_your_ministry_a_phone"
              />
            ...
            <div class="col-lg-12">
              <input
                ...
                @keyup.enter="saveMinistry"
                class="form-control-lg form-control border-0 px-0 bg-transparent"
                :placeholder="trans.app.give_your_ministry_a_website"
              />
            ...
            <div class="col-lg-12">
              <textarea
                ...
                @keyup.enter="saveMinistry"
                class="form-control-lg form-control border-0 px-0 bg-transparent"
                :placeholder="trans.app.give_your_ministry_a_description"
              ></textarea>
      ...
      <delete-modal
        ...
        :message="trans.app.deleted_ministries_are_gone_forever"
      ></delete-modal>
    </template>
  </admin-page>
</template>
  ...
  methods: {
    fetchData() {
      this.request()
        ...
        .catch(error => {
          this.$router.push({ name: "ministries" });
        });
    },
    ...
    saveMinistry() {
      ...
      this.request()
        .post("/api/v1/ministries/" + this.id, this.form)
        .then(response => {
          this.form.isSaving = false;
    ...
    deleteMinistry() {
      this.request()
        .delete("/api/v1/ministries/" + this.id)
        .then(response => {
