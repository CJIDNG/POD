    ...
    <template slot="main">
      <page-header>
        <template slot="action">
          <router-link
            v-permission="['create_designations']"
            :to="{ name: 'designations-create' }"
            class="btn btn-sm btn-outline-success font-weight-bold my-auto"
          >{{ trans.app.new_designation }}</router-link>
        </template>
      </page-header>
          ...
          <div class="mt-2">
            ...
            >
              ...
              <div class="ml-auto">
                ...
                >
                  {{ trans.app.created }} {{ moment(designation.created_at).locale(CurrentTenant.locale).fromNow() }}
                </span>
              </div>
            </div>
