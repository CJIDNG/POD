  ...
  <admin-page>
    <template slot="main">
          ...
          <div class="form-group mb-5">
            <div class="col-lg-12">
              <input
                ...
                :placeholder="trans.app.give_your_state_a_name"
                disabled
              />
            ...
            <div class="col-lg-12">
              <input
                ...
                @keyup.enter="saveState"
                class="form-control-lg form-control border-0 px-0 bg-transparent"
                :placeholder="trans.app.give_your_state_a_longitude"
              />
            ...
            <div class="col-lg-12">
              <input
                ...
                @keyup.enter="saveState"
                class="form-control-lg form-control border-0 px-0 bg-transparent"
                :placeholder="trans.app.give_your_state_a_latitude"
              />
            ...
            <div class="col-lg-12">
              <input
                ...
                @keyup.enter="saveState"
                class="form-control-lg form-control border-0 px-0 bg-transparent"
                :placeholder="trans.app.give_your_state_a_code"
                disabled
              />
      ...
      <delete-modal
        ...
        :message="trans.app.deleted_states_are_gone_forever"
      ></delete-modal>
    </template>
  </admin-page>
</template>
...
export default {
  ...
  methods: {
    ...
    saveState() {
      ...
      this.request()
        .post("/api/v1/states/" + this.id, this.form)
        .then(response => {
          this.form.isSaving = false;
