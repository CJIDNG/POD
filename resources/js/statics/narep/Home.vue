<template>
  <div>
    ...
    <main class="text-center">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="feature-item">
                      ...
                      <h3>FAAC Facts</h3>
                      <p class="text-muted">
                        Facts from Nigerian extractive industries initiative.
                      </p>
                    </div>
                  </div>
                  <div class="col-lg-6">
      ...
      <header>
        <iframe src="https://www.google.com/maps/d/embed?mid=16k4tL1oeUA8wE-B-WHNv4c1bP4w" width="100%" height="680"></iframe>
      </header> 
...
<style scoped>
  ...
  header.masthead {
    ...
    background: url("/images/narep/bg-pattern.png"), linear-gradient(to left, #c94b4b, #4b134f);
  }
